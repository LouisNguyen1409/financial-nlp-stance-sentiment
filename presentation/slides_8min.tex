...
\begin{frame}[t]{Results --- All 12 Systems}
    ...
    \centering
    {\small \textbf{Top-2 tied}: Multi-task FinBERT vs BERT-LLRD within $\pm 0.1$ pp. Multi-task \textbf{beats} single-task FinBERT by \textbf{+2.07 pp} sentiment F1 and \textbf{+1.90 pp} stance F1.}
    \end{minipage}
\end{frame}
