        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{3pt}
                \item \textbf{CLI} \texttt{cli.py}:\\
                      \texttt{--text} / \texttt{--file} / interactive
                \item \textbf{Gradio demo} \texttt{demo.py}:\\
                      web UI at \texttt{localhost:7860}
                \item \textbf{HuggingFace Hub}: 5 public repos\\
                      \texttt{Louisnguyen/multitask-finbert-financial}\\
                      \texttt{Louisnguyen/\{finbert,bert-llrd\}-financial-\{stance,sentiment\}}
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
