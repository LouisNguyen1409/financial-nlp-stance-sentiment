...
\begin{table*}[t]
\centering
\caption{Project Scope (COMP6713 2026 T1). Minimum 80 credits required; achieved \textbf{135+ credits}.}
\label{tab:scope}
\small
...
\midrule
\multicolumn{4}{@{}l}{\textbf{Part C: Modelling} (min. 30 credits) \hfill \textit{Achieved: 65+}} \\
...
Extend a method & 30 & Novel extension & Multi-task FinBERT (shared encoder + dual heads + weighted CE) \\
\midrule
\multicolumn{4}{@{}l}{\textbf{Part D: Evaluation} (min. 20 credits) \hfill \textit{Achieved: 30}} \\
...
and negative (13.4\%).  This imbalance motivates our use of weighted
