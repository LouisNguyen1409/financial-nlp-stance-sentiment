...
\begin{frame}{Baselines \& Pre-trained Probes}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item \textbf{FinBERT zero-shot}: native head with positive$\!\to\!$hawkish, negative$\!\to\!$dovish proxy for stance.
                \item \textbf{Few-shot $k{=}16$}: frozen encoder + \texttt{Linear(768,3)} probe on 48 examples.
                \item Probed: FinBERT, BERT, RoBERTa.
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
% ============================================================
\begin{frame}{Fine-tuning Recipes}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
...
\begin{frame}[t]{Results --- All 12 Systems}
    ...
    \centering
    {\footnotesize
    \textcolor{UNSWGreen}{$\blacksquare$} \textbf{Best baseline}: TF-IDF + SVM --- sub-ms inference; defensible floor for latency-sensitive / air-gapped deployment.\\
    \textcolor{UNSWRed}{$\blacksquare$} \textbf{Best pretrained}: FinBERT few-shot ($k{=}16$, 48 examples) --- matches full fine-tune sentiment (0.9670 vs 0.9459). Domain pretraining dominates in low-data.\\
...
% ============================================================
% Thank you slide (black on white)
% ============================================================
{
...
\begin{frame}[plain]
    \vfill
    \centering
    {\color{UNSWDarkBlue}\Huge\textbf{Thank you for listening!}}\\[1em]
    {\color{UNSWDarkBlue}\Large Q\&A time}
    \vfill
\end{frame}
}
